            ...
            <li class="list-group-item">
              ...
              <table class=download>
                ...
                <tr>
                  ...
                  <td><a style="pointer-events:none; cursor:normal; color:grey;" href="/blackarch/torrent/blackarch-linux-slim-2021.03.01-x86_64.iso.torrent" itemprop="fileFormat" type="application/octet-stream">Torrent coming soon!</a></td>
                  <td>4.5 GB</td>
                  <td>${SLIM_CHECKSUM}</td>
                </tr>
                <tr>
